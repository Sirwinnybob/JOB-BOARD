        ...
        {displayPdfs.map((pdf, index) => {
          ...
          return (
            ...
            >
              ...
              >
                {pdf.is_placeholder ? (
                  <div className="w-full bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 rounded-lg shadow-md border-2 border-dashed border-gray-300 dark:border-gray-600 flex items-center justify-center p-4 sm:p-6 md:p-8 transition-colors" style={{ aspectRatio: `${aspectWidth} / ${aspectHeight}`, maxHeight: '100%' }}>
