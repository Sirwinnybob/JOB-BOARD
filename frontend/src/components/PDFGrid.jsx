  ...
  return (
    ...
    >
      {Array.from({ length: totalSlots }).map((_, index) => {
        ...
        // Render placeholder
        if (pdf.is_placeholder) {
          return (
            <div
              key={pdf.id}
              className="relative aspect-[5/7] bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg shadow-md border-2 border-dashed border-gray-300 overflow-hidden"
            >
